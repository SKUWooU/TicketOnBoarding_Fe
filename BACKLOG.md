...
| 1-SEC | 운영 의존성 audit 11건에 critical·high 경로가 있다 | direct/transitive dependency와 breaking change 영향 | `audit fix --force`, major 일괄 upgrade | 진행 중 ([#6](https://github.com/SKUWooU/TicketOnBoarding_Fe/issues/6)) |
